...
func TestNeatServerPopulated(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			data: `{"apiVersion":"v1","kind":"Pod","metadata":{"name":"p","annotations":{"openshift.io/scc":"restricted-v2","seccomp.security.alpha.kubernetes.io/pod":"runtime/default"}},
				"spec":{"securityContext":{"fsGroup":1000700000,"seLinuxOptions":{"level":"s0:c10,c5"},"seccompProfile":{"type":"RuntimeDefault"}},
				"containers":[{"name":"c","image":"i","securityContext":{"runAsNonRoot":true,"runAsUser":1000700000}}],
				"initContainers":[{"name":"init","image":"i","securityContext":{"runAsUser":1000700000}}]}}`,
		...
		},
		{
			...
			data: `{"apiVersion":"v1","kind":"Pod","metadata":{"name":"p","annotations":{"openshift.io/scc":"anyuid"}},
				...
				"containers":[{"name":"c","image":"i","securityContext":{"runAsUser":1001}},{"name":"d","image":"i","securityContext":{"runAsUser":1000700001}}]}}`,
			want: `{"apiVersion":"v1","kind":"Pod","metadata":{"name":"p","annotations":{}},
				"spec":{"securityContext":{"fsGroup":2000,"seLinuxOptions":{"type":"spc_t","level":"s0:c1,c2"}},
				"containers":[{"name":"c","image":"i","securityContext":{"runAsUser":1001}},{"name":"d","image":"i","securityContext":{"runAsUser":1000700001}}]}}`,
		},
		{
			...
			data:  `{"apiVersion":"v1","kind":"Pod","metadata":{"name":"p","annotations":{"seccomp.security.alpha.kubernetes.io/pod":"localhost/profile.json"}},"spec":{"securityContext":{"runAsUser":1000700000,"seLinuxOptions":{"level":"s0:c10,c5"}}}}`,
			want:  `{"apiVersion":"v1","kind":"Pod","metadata":{"name":"p","annotations":{"seccomp.security.alpha.kubernetes.io/pod":"localhost/profile.json"}},"spec":{"securityContext":{"runAsUser":1000700000,"seLinuxOptions":{"level":"s0:c10,c5"}}}}`,
		},
		{
		...
		{
			title: "imagestream: the import timestamp goes",
			data:  `{"apiVersion":"image.openshift.io/v1","kind":"ImageStream","metadata":{"name":"i","annotations":{"openshift.io/image.dockerRepositoryCheck":"2026-01-01T00:00:00Z"}},"spec":{}}`,
			want:  `{"apiVersion":"image.openshift.io/v1","kind":"ImageStream","metadata":{"name":"i","annotations":{}},"spec":{}}`,
		},
		{
